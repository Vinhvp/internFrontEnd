            ...
            <styled.LoginCard>
                ...
                <styled.Container>
                    <form>
                        ...
                        <Input type="email" label="EMAIL" name="email" placeholder="aware@example.com" mb="24px" ></Input>
                        ...
                        <ButtonHome name="Log In" bgcolor="var(--white-four);" mb='85px' mt='46px'>Log In</ButtonHome>
                    </form>
